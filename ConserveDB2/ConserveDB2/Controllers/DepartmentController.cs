...
namespace ConserveDB2.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DId,departmentName,position")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DId,departmentName,position")] Department department)
        {
